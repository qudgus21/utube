...
app.use("/videos/uploads", _express["default"]["static"](_path["default"].join(__dirname, "uploads")));
app.use("/users/uploads", _express["default"]["static"](_path["default"].join(__dirname, "uploads")));
